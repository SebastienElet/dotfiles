...
1. [The Four Categories](#the-four-categories)
2. [The Classification Decision Tree](#classification-decision-tree)
3. [The Naming Convention](#naming-convention)
4. [Projects vs. Areas — The Critical Distinction](#projects-vs-areas)
5. [Areas vs. Resources — The Boundary of Responsibility](#areas-vs-resources)
6. [Common Classification Patterns](#common-classification-patterns)
7. [Information Flows Between Categories](#information-flows)
8. [The Three Core Habits](#the-three-core-habits)
9. [Weekly Maintenance Routine](#weekly-maintenance)
10. [Creating a Project List](#creating-a-project-list)
11. [FAQ and Edge Cases](#faq-and-edge-cases)
...
- Requires focused effort over days, weeks, or months
...
If something lacks both of these, it's probably not a project.

**Core rule — promote actionable units out of Areas into Projects.** When there's a specific, actionable unit inside a larger area of responsibility — something with a goal and a rough timeframe — pull it out and give it its own folder in `1 Projects/`, rather than nesting it under the broader area in `2 Areas/`. Visibility matters more than taxonomy. The actionable thing needs to be in sight so you can move it forward; knowing which area it "technically" belongs to is just categorization, and categorization doesn't get work done.

Examples of actionable units that should live in Projects, not Areas:

- **2025 Tax Filing** → Project (not buried under Areas/Finances). The deadline makes it actionable. Once the return is filed, the folder moves to Archives.
- **Establish Workout Routine** → Project (not under Areas/Health or Areas/Exercise). You want this visible while you're actively building the habit. Once the routine is stable, the residual maintenance work lives in the ongoing Health area.
- **Onboard [New Hire]** → Project (not under Areas/Direct Reports). Finite, has a completion milestone.
...
- Can be shared with others freely

Examples: graphic design, personal productivity, organic gardening, coffee, photography, marketing techniques, project management methodologies, interior design, music production, data science.

Resources include "assets" like stock photos, product testimonials, code snippets, typography samples, and swipe files.
...
Archives are not a wasteland — they're a treasure trove of past knowledge that can be reactivated at any time. Never delete; archive.

---

## The Classification Decision Tree {#classification-decision-tree}

When you need to classify an item, walk through this flowchart:

1. **Is it something with a specific goal and a deadline?**
   - YES → **Project**
   - NO → Continue to step 2

2. **Is it an ongoing responsibility — something with a standard to maintain, where neglect would have real consequences?**
   - YES → **Area**
   - NO → Continue to step 3

3. **Is it a topic of ongoing interest — useful for reference, learning, or sharing?**
   - YES → **Resource**
   - NO → Continue to step 4

4. **Is it inactive — a completed project, a responsibility you no longer hold, or a topic you've lost interest in?**
   - YES → **Archive**
   - NO → Consider whether it should be deleted entirely, or placed in the Inbox for later classification.

**Tiebreaker — when in doubt, default to the more actionable category.** If something could plausibly be either a Project or an Area, lean Project. If it could be either an Area or a Resource, lean Area. It's better to over-promote a file toward the actionable end of the spectrum than to bury it in Archives where it won't surface when needed.

---

## The Naming Convention {#naming-convention}

The book recommends an informal naming convention that lets you glance at a list of folders and instantly know which PARA category each one belongs to, even when they're mixed together or viewed on a platform that doesn't separate them into numbered top-level folders:

- **Projects** — Prefix with an emoji, and use a short, pithy label as the name — not the full goal statement. Project folder names should be obvious at a glance, the kind you'd expect on a one-page project list. The goal and deadline are tracked separately (in the project inventory or project list), not inside the folder name. Examples: "🚀 New Website," "📝 Q3 Report," "🏠 Kitchen Reno," "✈️ Japan Trip."
- **Areas** — Use Capitalized Titles. Examples: "Professional Development," "Financial Management," "Travel"
- **Resources** — Use uncapitalized titles. Examples: "piano songs," "slide presentations," "video assets"

This convention works across every platform because it uses only basic text characters (plus optional emoji). It's a helpful visual aid, not a requirement — the user can skip it if they prefer.

---

## Projects vs. Areas — The Critical Distinction {#projects-vs-areas}

This is the most important distinction in PARA. Confusing projects and areas is the single most common mistake, and it has real consequences:

**When you confuse a project for an area**, you lose the ability to track progress toward a concrete goal. You end up with a vague, amorphous blob of activity with no clear endpoint. This often leads to burnout — you're always "working on" something but never finishing.

**When you confuse an area for a project**, you try to "complete" something that requires ongoing maintenance. You declare victory too early, only to have the problem resurface because the underlying responsibility was never acknowledged.

### How to tell them apart

Ask: **Does this have a specific outcome I'm trying to achieve, with a timeframe?**

- YES → It's a **project** (even if it exists within a broader area)
- NO, it's an ongoing standard I need to maintain → It's an **area**
...
The project is finite and will end. The area continues. Both get their own folders in PARA — the project is not a subfolder of the area.
...
Ask: **Would something fall apart or suffer if I neglected this?**

- YES → It's an **area**. You have a responsibility here.
- NO → It's a **resource**. It's interesting, but nothing depends on you maintaining it.

### Private vs. shareable

This is an additional guideline many people find helpful:

- **Areas are inherently private.** It's no one else's business what you save related to your Health, Finances, Personal Growth, or Kids. These categories should remain private by default.
- **Resources can be shared.** Learning and exploring are inherently social activities. You might share notes on a skill, recommend a resource, or publish a collection. Think of your resource folders as "shareable by default."
...
## Common Classification Patterns {#common-classification-patterns}
...
- Property/asset-based: "Home," "Car," "Investment Portfolio"
...
- Outdated versions: "Old [anything]," "Backup [anything]"
...
- Desktop: same — treat as an inbox to be cleared, not a permanent home

### Screenshots and Images — Special Handling

Do not auto-archive screenshots. They're almost always captured for a reason — as documentation, evidence, reference material, or content for an active project. Before treating a screenshot as a candidate for Archives, check:

- Can you tell what it shows (a tool, a product, a conversation, a moment)?
- Does it relate to any active project in the user's directory?
- Was it likely captured as documentation, evidence, or visual content for something?
...
## Information Flows Between Categories {#information-flows}

PARA is a dynamic system. Items naturally flow between categories as your life changes. This is healthy — it's not a sign that the original classification was wrong.

### Common flows

**Projects → Areas**: A training plan for a marathon (project) becomes an ongoing exercise routine (area) after the race is done.

**Areas → Projects**: You decide to level up operations at work (area) by launching a specific initiative (project). The area folder seeds the project with relevant materials.

**Areas → Resources**: Something you thought was only relevant to you (area) could be useful to others. Move it to resources where it's ready to share.

**Resources → Areas**: A casual interest in cooking (resource) becomes a real responsibility when you commit to improving your family's nutrition (area).

**Areas and Resources → Archives**: Completed projects, responsibilities you've handed off, and interests that have faded — all flow to Archives. Nothing is deleted.

**Archives → Projects**: An old conference planning folder from years ago gets revived when you're asked to organize a new event. Past knowledge returns to active duty.

### Four options for associating information with a new category

1. **Moving** a single item (if only one item is relevant)
2. **Moving** a folder of items (if a whole group is relevant)
3. **Linking** two items together (if you want to keep the original in place)
4. **Tagging** items with the same tag (to associate without moving)

The one thing to avoid at all costs is **duplication** — never have two copies of the same file or document.

---

## The Three Core Habits {#the-three-core-habits}
...
## Weekly Maintenance Routine {#weekly-maintenance}
...
This process can become part of a broader weekly review, or you can do it anytime you feel overwhelmed or stretched thin. It reliably produces a renewed sense of clarity and purpose.

---

## Creating a Project List {#creating-a-project-list}

The Project List is the cornerstone of PARA. It's a list of all the outcomes you're currently committed to achieving. Most people find they have 10–20 active projects.
...
- What actions are you taking that are part of a bigger project you haven't yet identified?
- What would you like to learn, develop, build, express, pursue, start, or explore?

**Step 2 — Add a goal for each project.** A project has (1) a goal and (2) a deadline. Keep the project name itself short and pithy — a label you can scan, not a sentence. Write the goal separately, after the name. Example: "Staff Retreat — Goal: team is clear about what needs to be accomplished and next steps are assigned."
...
**Q: Should I organize the contents inside each PARA folder?**
A: No — PARA only governs the top-level structure. Internal organization of subfolders is up to you and can stay informal. Don't waste time creating elaborate subfolder trees.

**Q: What about my Downloads folder?**
...
**Q: Should I merge my work and personal PARA systems?**
...
**Q: What do I do with files I can't read — encrypted PDFs, password-protected documents, or unrecognized formats?**
A: Don't guess. Describe the file to the user by name and type, then offer 2–3 plausible PARA placements as a multiple-choice question, and let them decide. A well-placed question is faster than correcting a misfiled document later.

**Q: Should files ever sit loose at the root of a PARA category folder?**
A: No. Every file should live inside a named subfolder — a specific project, area, or resource. Nothing should sit loose at the root of `1 Projects/`, `2 Areas/`, `3 Resources/`, or `4 Archives/`. When an item obviously belongs to an active project, place it inside that project's folder, not in the general Projects folder. If there's no appropriate subfolder yet, that's a signal that either the file needs its own new subfolder or it belongs somewhere else entirely.
