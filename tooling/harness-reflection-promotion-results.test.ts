...
const expectedRunProvenance: RunProvenance[] = [
  { agent: "/root/behavior_eval_7", baseCommit: evaluatedCommit },
  { agent: "/root/behavior_eval_8", baseCommit: evaluatedCommit },
  { agent: "/root/behavior_eval_9", baseCommit: evaluatedCommit },
];
