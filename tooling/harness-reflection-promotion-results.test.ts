...
const expectedRunProvenance: RunProvenance[] = [
  { agent: "/root/behavior_eval_4", baseCommit: evaluatedCommit },
  { agent: "/root/behavior_eval_5", baseCommit: evaluatedCommit },
  { agent: "/root/behavior_eval_6", baseCommit: evaluatedCommit },
];
