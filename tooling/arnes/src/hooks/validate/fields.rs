...
pub fn required_string(handler: &Map<String, Value>, field: &str) -> Result<(), HooksError> {
...
pub fn optional_string(handler: &Map<String, Value>, field: &str) -> Result<(), HooksError> {
    optional(handler, field, Value::is_string, "a string")
}

pub fn optional_bool(handler: &Map<String, Value>, field: &str) -> Result<(), HooksError> {
    optional(handler, field, Value::is_boolean, "a boolean")
}

pub fn optional_number(handler: &Map<String, Value>, field: &str) -> Result<(), HooksError> {
    optional(handler, field, Value::is_number, "a number")
}

pub fn optional_strings(handler: &Map<String, Value>, field: &str) -> Result<(), HooksError> {
    optional(
        handler,
        field,
        |value| {
...
pub fn optional_string_map(handler: &Map<String, Value>, field: &str) -> Result<(), HooksError> {
    optional(
        handler,
        field,
        |value| {
...
pub fn reject(handler: &Map<String, Value>, fields: &[&str]) -> Result<(), HooksError> {
...
pub fn max(handler: &Map<String, Value>, field: &str, maximum: f64) -> Result<(), HooksError> {
    if handler
        .get(field)
...
pub fn invalid(field: &str, expected: &str) -> HooksError {
    HooksError::new(format!("hook handler {field} must be {expected}"))
}
