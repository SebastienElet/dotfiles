...
use arnes::memory::{ProcessRunner, SystemProcessRunner, resolve_project};
...
fn assert_scope_unavailable<T: std::fmt::Debug>(result: Result<T, arnes::memory::MemoryError>) {
