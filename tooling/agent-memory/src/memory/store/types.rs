...
pub enum StoreFailpoint {
    ...
    BeforeIndexRename,
    BeforeCacheWrite,
    PauseAfterCacheRead(Arc<Barrier>),
    PauseBeforeCacheRename(Arc<Barrier>),
    PauseAfterRetrievalEntryRead(Arc<Barrier>),
...
pub(crate) enum StorePhase {
    ...
    AfterIndexEntryRead,
    AfterCacheRead,
    BeforeCacheTemporaryCreate,
    BeforeCacheWrite,
    BeforeCacheFlush,
    BeforeCacheFsync,
    BeforeCacheRename,
    AfterRetrievalEntryRead,
}
    ...
    fn matches(&self, phase: StorePhase) -> bool {
        matches!(
            ...
            (
                ...
                | (Self::BeforeCacheWrite, StorePhase::BeforeCacheWrite)
        )
    }
}
